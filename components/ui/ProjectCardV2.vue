<template>
  <article class="project-card">
    ...
    <div class="title">
      ...
      <p v-if="author" class="author consumes-click">
        by {{ author }}
      </p>
    </div>
    ...
    <div class="stats">
      <span
        v-if="downloads"
        v-tooltip="`${formatNumber(downloads, false)} downloads`"
      ...
      <span
        v-if="follows"
        v-tooltip="`${formatNumber(follows, false)} followers`"
        class="stat consumes-click"
      >
      ...
      <span
        ...
        v-tooltip="`Updated ${dayjs(updatedAt).format('MMMM D, YYYY [at] h:mm A')}`"
        class="stat consumes-click"
      >
      ...
      <span
        v-else-if="createdAt"
        v-tooltip="`Published ${dayjs(createdAt).format('MMMM D, YYYY [at] h:mm A')}`"
        class="stat consumes-click"
      >
